...
extension AcceptedOrderVC {
    static func instantiate() -> AcceptedOrderVC {
        StoryBoardConstants.order.instantiateViewController(withIdentifier: String(describing: AcceptedOrderVC.self)) as! AcceptedOrderVC
    }
}

class AcceptedOrderVC: UIViewController {
    ...
    private func setupView() {
        setupDelegates()
        uiViewToolBar.labelTitle.text = "Accepted"
        setupTableView()
        getAcceptedOrder(isLoading: true)
    }
...
extension AcceptedOrderVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.btnView.setTitle("Assign", for: .normal)
        cell.btnView.backgroundColor = .appColor.assignColor
        ...
        cell.btnViewHandler = { [self] in
            ...
            vc.userType = orderData[indexPath.row].userType ?? ""
...
extension AcceptedOrderVC {
    ...
    private func getAcceptedOrder(isLoading: Bool = false) {
        ...
        Networking.request(
            ...
            switch response {
                ...
                case .success(let data):
                    ...
                    let orderResponse = NetworkHelper.decodeJsonData(data: jsonData, decodeWith: CommonOrderApiReponse.self)
...
extension AcceptedOrderVC: ToolBarDelegate, OrderUpdateDelegate {
