...
extension LogisticDeliveryVC {
    static func instantiate() -> LogisticDeliveryVC {
        StoryBoardConstants.order.instantiateViewController(withIdentifier: String(describing: LogisticDeliveryVC.self)) as! LogisticDeliveryVC
    }
}

class LogisticDeliveryVC: UIViewController {
    ...
    private func setupView() {
        ...
        setupDelegates()
        uiViewToolBar.labelTitle.text = "Logistic Delivery"
        uiViewToolBar.backgroundColor = .clear
        setupTableView()
        getExternalDelivery(isLoading: true)
    }
...
extension LogisticDeliveryVC: UITableViewDelegate, UITableViewDataSource {
...
extension LogisticDeliveryVC {
    ...
    private func getExternalDelivery(isLoading: Bool = false) {
...
extension LogisticDeliveryVC: ToolBarDelegate {
